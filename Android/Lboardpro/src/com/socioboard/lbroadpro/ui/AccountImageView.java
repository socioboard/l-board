package com.socioboard.lbroadpro.ui;
...
public class AccountImageView extends ImageView {
    ...
    public AccountImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AccountImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        // Attribute initialization
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AccountImageView,
                defStyle, 0);

        mMaskDrawable = a.getDrawable(R.styleable.AccountImageView_maskDrawable);
        if (mMaskDrawable != null) {
            mMaskDrawable.setCallback(this);
        }

        mBorderDrawable = a.getDrawable(R.styleable.AccountImageView_borderDrawable);
        if (mBorderDrawable != null) {
            mBorderDrawable.setCallback(this);
        }

        mDesaturateOnPress = a.getBoolean(R.styleable.AccountImageView_desaturateOnPress,
                mDesaturateOnPress);
